...
<body class="bg-gray-800 text-white font-sans min-h-screen flex flex-col">
  ...
  <div class="flex-grow flex items-center justify-center">
    <div class="w-full max-w-7xl px-6">
      ...
      <div class="bg-white text-black rounded-2xl p-8 shadow-xl">
    <span class="text-3xl block mb-2">📦</span>
    <p class="text-gray-700 text-lg font-semibold mb-2">Chips</p>
    <ul class="text-gray-700 text-sm">
      <li>Total Items: 150</li>
      <li>Remaining Items: 90</li>
      <li>Sold Items: 60</li>
      
    </ul>
    <p class="text-gray-700 text-lg font-semibold mb-2">Pen</p>
    <ul class="text-gray-700 text-sm">
      <li>Total Items: 150</li>
      <li>Remaining Items: 90</li>
      <li>Sold Items: 60</li>
