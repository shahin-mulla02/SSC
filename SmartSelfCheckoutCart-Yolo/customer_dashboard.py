...
def payment_success():
    ...
    # Get scanned items
    try:
        with open("static/scanned_items.json") as f:
    ...
    return render_template("customer2_dashboard.html", username=username, scanned_items=[])
...
def email_receipt():
    ...
    sender_email = "tasnimmulla18@gmail.com"
    sender_password = "wurrgxbqwvdlfptj"  # Use app password here
